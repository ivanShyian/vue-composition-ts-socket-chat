<template>
  <div
      ...
      border-gray-800 dark:border-gray-500 cursor-pointer dark:bg-gray-700
      dark:hover:bg-blue-50 dark:hover:bg-opacity-20 transition-all duration-300 pr-3 md:pr-0"
        :class="{'dark:bg-blue-50 dark:bg-opacity-10' :isActiveChat}"
  >
    <ChatsCardAvatar
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const isActiveChat = computed(() => route.params?.userID === nicknameCard.value)
